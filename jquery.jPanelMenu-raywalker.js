    ...
    $.jPanelMenu = function(options) {
        var jP = {
                ...
                if (animationChecks.transitions || animationChecks.none) {
                    ...
                    if (jP.settings.shiftFixedChildren)
                    {
                        $(jP.fixedChildren).each(function() {
                            ...
                            if (animationChecks.transitions) {
                                jP.enableFixedTransitions(selector, identifier, jP.options.closeDuration, jP.options.closeEasing);
                            }
            ...
            initiateClickListeners: function() {
                $(doc).on('click', jP.options.trigger, function() {
                    jP.triggerMenu(jP.options.animated);
                    return false;
                });
            },
            destroyClickListeners: function() {
                $(doc).off('click', jP.options.trigger, null);
            },
            initiateContentClickListeners: function() {
                ...
                $(doc).on('click', jP.panel, function() {
                    if (jP.menuIsOpen()) {
                        jP.closeMenu(jP.options.animated);
                    }
                });

                $(doc).on('touchend', jP.panel, function() {
                    if (jP.menuIsOpen()) {
                        jP.closeMenu(jP.options.animated);
                    }
                });
            ...
            destroyContentClickListeners: function() {
                ...
                $(doc).off('click', jP.panel, null);
                $(doc).off('touchend', jP.panel, null);
            },
